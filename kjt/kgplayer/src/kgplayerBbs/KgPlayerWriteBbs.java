...
public class KgPlayerWriteBbs extends JFrame{
	...
	public KgPlayerWriteBbs() {
		...
		JLabel loadNameLabel = new JLabel("name load");
		loadNameLabel.setBounds(115, 76, 133, 38);
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			if (textField.getText().equals("") || textField1.getText().equals("")) {
				...
				//dto.setId(sc.next()); 마이페이지에서 가져오기
	...
	public static void main(String[] args) {
		KgPlayerWriteBbs main = new KgPlayerWriteBbs();
	}
